        ...
        public class Conversation
        {
            public static void callfilecode(TcpClient client, string name, string s)
            {
                try {
                    if (s.Contains("/"))
                    {
                        string filePath = @"C:/Users/agilan.v/Desktop/send/";
            ...
            public static void callvoicechat(TcpClient client, string name, string s)
            {
                try {
                    ...
                    Console.ReadLine();
                    mciSendString("save recsound C:\\Users\\agilan.v\\Desktop\\send\\result.wav", "", 0, 0);
            ...
            while (true)
            {
                try
                {
                    ...
                    else if ((messagedata == "file")||(messagedata=="privatefile"))
                    {
                        ...
                        string receivedPath = @"C:/Users/agilan.v/Desktop/receive/";
